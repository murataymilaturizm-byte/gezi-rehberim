-- ============================================================
-- FIX 2: process_whatsapp_message_atomic history LIMIT 20 → 50
-- Uzun konuşmalarda (dil değişimi, çok sorgu) 20 mesaj yetmiyordu.
-- ============================================================
...
BEGIN
  ...
  -- LIMIT 50: uzun konuşmalar + dil değişimi için yeterli buffer
