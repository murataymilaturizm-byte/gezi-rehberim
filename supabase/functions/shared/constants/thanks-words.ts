...
export const THANKS_FAREWELL_RE =
  /(?<![\p{L}\p{N}])(te[şs]ekkür\p{L}*|sa[ğg]\s?ol\p{L}*|eyvallah|görü[şs]ürüz|iyi\s+günler|ho[şs][çc]a\s?kal\p{L}*|thanks|thank\s+you|thx|bye|goodbye|see\s+you|dank\p{L}*|tsch[üu]ss|merci|au\s+revoir|gracias|adi[óo]s|hasta\s+luego|спасибо|благодарю|до\s+свидания|пока|شكرا\p{L}*|مع\s+السلامة|وداعا)(?![\p{L}\p{N}])/iu;
